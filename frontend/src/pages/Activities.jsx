      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-medium capitalize transition ${
                filter === cat
                  ...
                  : 'bg-white bg-opacity-10 text-blue-300 hover:bg-opacity-20 border border-white border-opacity-10'
              }`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map((a) => (
            <div
              key={a.id}
              className={`bg-white bg-opacity-10 border rounded-2xl p-6 flex flex-col gap-3 hover:bg-opacity-20 transition ${categoryColors[a.category]}`}
            >
